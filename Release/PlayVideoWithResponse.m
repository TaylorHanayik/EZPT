function [reject,movieduration,fps,framecount,onsettime,droppedcount,response,reactiontime] = PlayVideoWithResponse(params, moviename)
%
%
...
b1 = KbName('1!');
b2 = KbName('2@');
RestrictKeysForKbCheck([k1,k2,b1,b2,esc]);
