function [reject,onsettime,droppedcount,movieduration] = LoadMovieIntoBackGround(params, moviename,movieIsMat)
%[reject,movieduration,fps,framecount,onsettime,droppedcount] = PlayVideo(params, movie,movieIsMat)
%
%
...
for i=1
    ...
    if movieIsMat == 0
        [movie movieduration fps] = Screen('OpenMovie', params.win, moviename,[],1);%keep only this
    end
